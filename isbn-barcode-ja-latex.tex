...
\subsubsection{「{\jfontspec{OCRB-Regular} \UTF{00A5}}」マーク使用例１：フォント}
...
\subsubsection{「{\jfontspec{OCRB-Regular} \UTF{00A5}}」マーク使用例２：SVG}
\begin{itemize}
...
\end{table}
\vspace{-4mm}
表記例：{\fontspec{ocrb7}C0197 \includesvg[width=5.4pt]{./images/ocrb-yen.svg}\hspace{1.pt}940E}  
