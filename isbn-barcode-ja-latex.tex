...
\subsubsection{「{\jfontspec{OCRB-Regular} \UTF{00A5}}」マーク使用例１：フォントA}
...
\subsubsection{「{\jfontspec{OCRB-Regular} \UTF{00A5}}」マーク使用例２：フォントB}
...
\hspace{37pt}\fRMono{\{\bs fontspec\{ocrb7\}C0197 \{\bs jfontspec\{{\colH{800000}OCRB-Free}\} \bs UTF\{{\colH{800000}00A5}\}\}940E\}}\vspace{4mm}\\
...
\subsubsection{「{\jfontspec{OCRB-Regular} \UTF{00A5}}」マーク使用例３：SVG}
\begin{itemize}
...
\begin{enumerate}
  ...
  \item SVG画像 \footnote{\href{https://kikakurui.com/x9/X9001-1976-01.html}{「日本工業規格 JISX 9001-1976 光学式文字認識のための字形（英数字）}」に準拠しています。\\kikakurui.com: https://kikakurui.com/x9/X9001-1976-01.html} \\
